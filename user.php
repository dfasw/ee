...
$perNumber=20; 
$url=$_GET['url']; 
$count=mysqli_query($conn,"select count(*) from msg where uid = $id"); 
...
$myuser=mysqli_query($conn,"select * from msg where uid = $id order by id desc limit $startCount,$perNumber");
$day = $user['qd'];
...
<div id="mian" class="container">
	<div id="col" class="col-md-9">
		...
		<?php
		while($row = mysqli_fetch_array($myuser))
		{
        $day = $row['day'];
		?>
		<div class="panel panel">
			<div id="bodyxia" class="panel-body">
				<div class="media">
					...
					<div class="media-body">
						...
						if ($row['upload']!=""){
						?>
							<img class="lazy img-responsive" src="img/ico/timg.gif" data-original="upload/<?php echo $row['upload'];?>" width="200" height="20%">
						<?php
						}
						?>
						</div>
		...
		<ul class="pager">
			...
			if ($url != 1){
			?>
          		<li><a id="fanye" href="user.php?id=<?php echo $usid;?>&url=1"><i class="fa fa-step-backward" aria-hidden="true"></i></a><li>
				<li><a id="fanye" href="user.php?id=<?php echo $usid;?>&url=<?php echo $url - 1;?>"><i class="fa fa-chevron-left" aria-hidden="true"></i></a><li>
			...
			if ($url<$totalPage){
			?>
				<li><a id="fanye" href="user.php?id=<?php echo $usid;?>&url=<?php echo $url + 1;?>"><i class="fa fa-chevron-right" aria-hidden="true"></i></a><li>
          		<li><a id="fanye" href="user.php?id=<?php echo $usid;?>&url=<?php echo $totalPage;?>"><i class="fa fa-step-forward" aria-hidden="true"></i></a><li>
			<?php
			}
			?>
		</ul>
